...
instance tracking, customizable print symbols, comparison capabilities,
and an alternative constructor for creating squares.
"""
...
class Rectangle:
    ...
    def square(cls, size=0):
        """Creates a new Rectangle instance configured as a square.

        Args:
            size (int): The width and height size of the new square.
